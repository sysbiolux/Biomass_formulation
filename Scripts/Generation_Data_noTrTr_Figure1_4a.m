...
save('models_keep_single_CCLE_noTrTr_biomass_medium','models_keep_single')

end

load models_keep_single_CCLE_noTrTr_biomass_medium
optional_settings.func = {'biomass_reaction'};
model = Cmodel;
...
save('KO_noTrTr_biomass_CCLE_medium','grRatio_biomass_single','grRateKO_biomass_single','grRateWT_biomass_single','genelist')
