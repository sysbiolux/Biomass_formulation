...
optional_settings.func = {'RCR99998'};
...
%% Single models
[~, A] = fastcormics_RNAseq(Cmodel, discretized(:,i), rownames, iHsa_genes, ...
...
save('models_keep_single_CCLE_iHsa_input_biomass_medium.mat','models_keep_single')

end

%load models_keep_single_CCLE_iHsa_input_biomass_medium.mat
optional_settings.func = {'RCR99998'};
model = Cmodel;
...
for i=1:size(models_keep_single,2)
        ...
        save('KO_generic_biomass_CCLE_medium_iHsa_input','grRatio_biomass_single','grRateKO_biomass_single','grRateWT_biomass_single','genelist')
        end
