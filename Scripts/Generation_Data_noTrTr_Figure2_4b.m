...
optional_settings.func = {'BIOMASS_maintenance_noTrTr'};
...
save('models_keep_single_CCLE_noTrTr_input_biomass_medium','models_keep_single')

end

%load models_keep_single_CCLE_noTrTr_input_biomass_medium
optional_settings.func = {'BIOMASS_maintenance_noTrTr'};
...
for i=1:size(models_keep_single,2)
        ...
        save('KO_generic_biomass_CCLE_medium_noTrTr_input','grRatio_biomass_single','grRateKO_biomass_single','grRateWT_biomass_single','genelist')
