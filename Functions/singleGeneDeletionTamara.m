function [grRatio, grRateKO, grRateWT, hasEffect, delRxns, fluxSolution, geneList] = singleGeneDeletionTamara(model, method, geneList, verbFlag, uniqueGene)
